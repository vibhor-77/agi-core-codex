...
def _instantiate(name: str):
    registry = {
        ...
        "arc-border-match-projection": BorderMatchProjectionStrategy,
        "arc-bottom-center-marker": BottomCenterMarkerStrategy,
        "arc-collinear-gap-bridge": CollinearGapBridgeStrategy,
        "arc-diagonal-cross-projection": DiagonalCrossProjectionStrategy,
        "arc-extract-transform": ExtractTransformStrategy,
        "arc-hole-projection": HoleProjectionStrategy,
        "arc-hollow-solid-rectangles": HollowSolidRectanglesStrategy,
        "arc-interior-extract": InteriorExtractStrategy,
        "arc-motif-completion": MotifCompletionStrategy,
        "arc-open-frame-fill": OpenFrameFillStrategy,
        "arc-orth-diagonal-halo": OrthDiagonalHaloStrategy,
        "arc-ray-extension": RayExtensionStrategy,
        "arc-relocate-shape-next-to-line": RelocateShapeNextToLineStrategy,
        "arc-recolor-components-by-top-order": RecolorComponentsByTopOrderStrategy,
        "arc-recolor-isolated-singletons": RecolorIsolatedSingletonsStrategy,
        "arc-right-parity-column-recolor": RightParityColumnRecolorStrategy,
        ...
        "arc-scaffold-column-projection": ScaffoldColumnProjectionStrategy,
        ...
        "arc-template-propagation": TemplatePropagationStrategy,
